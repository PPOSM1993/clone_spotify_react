    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="bg-white text-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer">
            Install App
          </p>
          <p></p>
      ...
      <div className="flex items-center gap-2 mt-4">
        ...
        <p className="text-white px4 py-1 rounded-2xl">Music</p>
        <p className="text-white px4 py-1 rounded-2xl">Podcasts</p>
      </div>
    </>
  );
};
